...
class StrategyV2ConfigTrailing(BaseClientModel):
    """
...
class StrategyV2Trailing(ScriptStrategyBase):
    """
    ...
    @classmethod
    def init_markets(cls, config: StrategyV2ConfigTrailing):
        """
    ...
    def __init__(self, connectors: Dict[str, ConnectorBase], config: Optional[StrategyV2ConfigTrailing] = None):
