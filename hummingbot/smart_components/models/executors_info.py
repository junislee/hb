...
class ExecutorInfo(BaseModel):
    ...
    config: Union[TrailingGridExecutorConfig, PositionExecutorConfig, XEMMExecutorConfig, ArbitrageExecutorConfig, DCAExecutorConfig, TWAPExecutorConfig, ExecutorConfigBase]
    net_pnl_pct: Decimal
